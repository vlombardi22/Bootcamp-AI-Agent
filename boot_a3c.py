...
from newutil import v_wrap, set_init, push_and_pull, record_boot, tracker, get_dist, \
...
class Worker(mp.Process):
    ...
    def __init__(self, gnet, gnav, gammo, opt, global_ep, global_ep_r, res_queue, name, f, l, stric, global_kills,
    ...
    def run(self):  # bookmark
        ...
        while (not IS_TEST and self.g_ep.value < MAX_EP) or (IS_TEST and episode < MAX_EP):
            ...
            #    print(len(state['items']['health']))
            #    print(len(state['items']['ammo']))
            t_count = e_count
            kills = 0
...
def main(f, my_q, fname, my_r):
    ...
    if mp.cpu_count() < 6:
        ...
        exit()
    workers = [
        Worker(gnet, gnav, gammo, opt, global_ep, global_ep_r, res_queue, i, act_net, l, stric, global_kills,
               global_health, global_ammo, my_q) for
        i in
        range(cp_count)]
...
if __name__ == "__main__":
    ...
    # name of csv file
    filename = "boot_order.csv"
    
    if IS_CONTROL:
        filename = "control_order.csv"
    ...
    if IS_TEST:
        while True:
            ...
            if r is not None:
                ...
                break
    """
    f = open("myout_task123_a2c.txt", "w")
    # if IS_TEST:
    f.write("boot\n")
    while True:
        r = my_q.get()
...
"""
control
[327, -1601.496, 0.35697599]
[718, -747.3425, 0.664584335]
[617, -997.9695, 0.619921336]
[682, -429.413, 0.6662393329999999]
[128, -1074.314, 0.17383334100000003]

[123, -2331.801, 0.196025]
[752, -627.4205, 0.693757667]
[319, -1516.047, 0.369083662]
[525, -1223.544, 0.5775389989999999]
[676, -868.6235, 0.6368470079999999]

[612, -878.068, 0.602064987]
[323, -1385.841, 0.35102401399999994]
[799, -494.9215, 0.717624665]
[647, -963.2545, 0.627928652]
[570, -1074.6065, 0.618466993]


boot
[723, -683.03, 0.685254005]
[630, -939.8245, 0.635496998]
[766, -420.014, 0.713631992]
[650, -959.1715, 0.6325963480000001]
[650, -876.8565, 0.6467676750000001]

[589, -1063.4575, 0.6095123329999999]
[779, -559.631, 0.7118976720000001]
[794, -486.9265, 0.723832002]
[490, -1408.1545, 0.548102663]
[594, -1122.425, 0.6058830199999999]

[747, -632.1545, 0.696494996]
[628, -927.005, 0.591614656]
[616, -1093.5795, 0.596296018]
[588, -1046.243, 0.578865005]
[564, -1036.2915, 0.6149233260000001]
